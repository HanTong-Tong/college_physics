...
export default {
  ...
  methods: {
      ...
      for (let i = 0; i < mark; i++) {
        if (this.tableData[i].postate == 2 && this.tableData[i].state == 2) {
          if (this.form.experiment_name == "欧姆表的改装设计") {
            fileUrl = {
              fileUrl:
                "http://wuli.stu.520116.fun/api/experiment6/pdf6?student_id=" +
                this.tableData[i].id,
              renameFileName:
            ...
            fileUrl = {
              fileUrl:
                "http://wuli.stu.520116.fun/api/experiment9/pdf9?student_id=" +
                this.tableData[i].id,
              renameFileName:
                this.tableData[i].student_class +
                "-" +
          ...
          if (this.form.experiment_name == "劈尖测细丝实验") {
            ...
            fileUrl = {
              fileUrl:
                "http://wuli.stu.520116.fun/api/experiment10/pdf10?student_id=" +
                this.tableData[i].id,
              renameFileName:
                this.tableData[i].student_class +
                "-" +
          ...
          if (this.form.experiment_name == "箱式直流电桥测量电阻") {
            fileUrl = {
              fileUrl:
                "http://wuli.stu.520116.fun/api/bridge/pdf?student_id=" +
                this.tableData[i].id,
              renameFileName:
                this.tableData[i].student_class +
                "-" +
            ...
            fileUrl = {
              fileUrl:
                "http://wuli.stu.520116.fun/api/experiment1/pdf1?student_id=" +
                this.tableData[i].id,
              renameFileName:
                this.tableData[i].student_class +
                "-" +
            ...
            fileUrl = {
              fileUrl:
                "http://wuli.stu.520116.fun/api/pendulum/pdf3?student_id=" +
                this.tableData[i].id,
              renameFileName:
                this.tableData[i].student_class +
                "-" +
            ...
            fileUrl = {
              fileUrl:
                "http://wuli.stu.520116.fun/api/completion15/pdf15?student_id=" +
                this.tableData[i].id,
              renameFileName:
                this.tableData[i].student_class +
                "-" +
          ...
          // }
            ...
            fileUrl = {
              fileUrl:
                "http://wuli.stu.520116.fun/ api/bridge1/pdf5?student_id=" +
                this.tableData[i].id,
              renameFileName:
                this.tableData[i].student_class +
                "-" +
            ...
            fileUrl = {
              fileUrl:
                "http://wuli.stu.520116.fun/ api/experiment14/pdf14?student_id=" +
                this.tableData[i].id,
              renameFileName:
                this.tableData[i].student_class +
                "-" +
            ...
            fileUrl = {
              fileUrl:
                "http://wuli.stu.520116.fun/ api/experiment11/pdf11?student_id=" +
                this.tableData[i].id,
              renameFileName:
                this.tableData[i].student_class +
                "-" +
    ...
    //     "http://wuli.stu.520116.fun/ api/findall"
    //   );
    ...
    //         arrID.push(fileUrl);
    //       }
    //       if (res.data[i].experiment_name == "电表改装设计实验") {
    //         fileUrl = {
    //           fileUrl:
    //             "http://wuli.stu.520116.fun/ api/experiment10/pdf10?student_id=" +
    //             res.data[i].id,
    ...
    async daochu(id) {
      ...
      if (this.form.experiment_name == "欧姆表的改装设计") {
        ...
        window.location.href =
          "http://wuli.stu.520116.fun/api/experiment/pdf?student_id=" +
          this.student_id;
      } else if (this.form.experiment_name == "电表改装设计实验") {
        window.location.href =
          "http://wuli.stu.520116.fun/api/experiment10/pdf10?student_id=" +
        ...
        window.location.href =
          "http://wuli.stu.520116.fun/api/experiment4/pdf4?student_id=" +
          this.student_id;
    ...
    async excel() {
      window.open(
        "http://wuli.stu.520116.fun/ api/excel/put?student_class=" +
          this.form.student_class
      );
    },
  },
